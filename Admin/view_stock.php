                  ...
                  <div class="x_content">
				   ...
				   <div class="" role="tabpanel" data-example-id="togglable-tabs">
					  ...
					  <div id="myTabContent" class="tab-content">
						...
						<?php
						$result1 = $link->query("select stockname from stocklist");
...
if($id=="Select Item")
{
$result = $link->query("SELECT * FROM `stockentry` WHERE Date BETWEEN '$dat' AND '$dat2' AND `del`='0'");
}
else
{
$result = $link->query("SELECT * FROM `stockentry` WHERE Date BETWEEN '$dat' AND '$dat2' AND `del`='0' AND `Itemname`='$id'");
}
$i=1;
...
<td style="text-align:center;"><b><i><?php echo $s; ?></i></b> </td>
			...
			<td  style="text-align:center;"> <b><i><?php echo $s1; ?> </i></b> </td>
