		 	...
		 	$abc= base64_encode($img1);
                   ...
                   <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <ul class="list-unstyled user_data">
                        ...
                        <li class="m-top-xs">
                          <i class="fa fa-external-link user-profile-icon"></i><?php echo $s['Agency'];?>
                        </li>
                      </ul>                      
                      <br />
					  <?php } ?> 
                  ...
                  <!--<form class="form-horizontal form-label-left" data-parsley-validate>-->
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
						...
						<li role="presentation" class=""><a href="#tab_content3" role="tab" id="search-tab1" data-toggle="tab" aria-expanded="false">LOADS</a>
                        </li>
						<li role="presentation" class=""><a href="#tab_content4" role="tab" id="search-tab2" data-toggle="tab" aria-expanded="false">CUSTOM LOAD</a>
                        </li>					
                      </ul>
					...
					$g= $d['COUNT(id)'];
						 ...
						 ?>
                        <label class="control-label col-md-3 col-sm-3 col-xs-6">Total Loads: <?php echo $g; ?>   </label>   
                 <?php
                ...
                ?> 
				  ...
				  <div id="divToPrint">          
					 ...
					 <table id="datatable-buttons" class="table table-striped table-bordered ">					
                      ...
                      <tbody>
					  				<?php
$sql = "SELECT * FROM `payment` WHERE `Design_ty`='Dealer' AND `del`='0' AND `empid`='$data'";
...
<?php
$sql1 = "SELECT * FROM `material_in` WHERE `dealerid` = '$data' and `delete`='0' ";
    ...
    echo "<td><label disabled><font color='#ff0000'>unpaid</font></label></td>";
		...
		echo "<td><label disabled><font color='#00FF00'>paid</font></label></td>";
			...
			?> </tr><?php $i++; } ?>
					 ...
					 <div role="tabpanel" class="tab-pane fade active" id="tab_content4" aria-labelledby="search-tab2">
                     <div class="col-md-12 col-sm-12 col-xs-12">
...
$("#dat").click(function()
{
var id = $('input[name="date"]').val();
var name = $('input[name="date1"]').val();
var nam = "<?php echo $data; ?>";
var dataString = 'id='+ id+'&name='+ name+'&nam='+ nam ;
$.ajax
({
type: "POST",
url: "ajaxdealercustom.php",
data: dataString,
cache: false,
