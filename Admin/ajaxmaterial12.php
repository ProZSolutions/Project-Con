...
$result = mysqli_query($link,$sql);
 while($rs = mysqli_fetch_object($result)){  ?>
	...
	<label class="auto-style1">Material Name</label><input type="text" name="id11" value="<?php echo stripslashes($rs->material_name); ?>" class="auto-style7"  style="width: 221px" ><br><br></br>
