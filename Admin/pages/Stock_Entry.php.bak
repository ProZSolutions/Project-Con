...
if($nam1==$data)
	{
    $sql = "INSERT INTO `stockentry` (`Date`,`Itemname`,`Quantity`,`Rate`,`Discount`,`Bill`,`Total`)
    VALUES('$dat1','$item','$quantity1','$rate1','$discount1','$adata',$total)";
    mysqli_query($link,$sql);
	}
}	 

}	
$sqlq = "select stockname from stocklist";
...
<form action="Stock_Entry" class="form-horizontal form-label-left" data-parsley-validate  method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-md-3 col-sm-3 col-xs-6 ">
                       <input  id="date" name="dat" class="date-picker form-control col-md-2 col-xs-10" required="required" type="text" >
                         ...
                         <div class="form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Item Name <span class="required" style="color:red;">*</span>
                         </label>
			   ...
			   <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Quantity<span class="required" style="color:red;">*</span>
                  </label>
                    <div class="col-md-5 col-sm-6 col-xs-12">
                       <input type="text" name="quantity" id="id1" required="required" class="form-control col-md-7 col-xs-12">
                         </div>
					       </div>
					         <div class="item form-group">
                               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">Rate <span class="required" style="color:red;">*</span>
                                 </label>
						             <div class="col-md-5 col-sm-6 col-xs-12">
                                       <input type="text" name="rate" id="id2" required="required" class="form-control col-md-7 col-xs-12" onKeyup="sum()" onkeypress="return isNumberKey(event,this.id)" >
                                         </div>
						                   </div>
										     <div class="item form-group">
                               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">Amount <span class="required" style="color:red;">*</span>
						             ...
						             <div class="col-md-5 col-sm-6 col-xs-12">
                                       <input type="text" name="amount" id="id3" required="required" class="form-control col-md-7 col-xs-12" onkeypress="return isNumberKey(event,this.id)">
                                         </div>
						                   </div>
										   <div class="item form-group">
                               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">Discount <span class="required" style="color:red;">*</span>
                                 </label>
						             <div class="col-md-5 col-sm-6 col-xs-12">
                                       <input type="text" name="discount" id="first-name" required="required" class="form-control col-md-7 col-xs-12" onkeypress="return isNumberKey(event,this.id)">
                                         </div>
						                   </div>										   
								  <div class="form-group">
