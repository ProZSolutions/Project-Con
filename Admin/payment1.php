          ...
          <div class="">
			...
			<div class="row">
             <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Load Entry<small>only in English</small></h2>
                    ...
                    <br>
                     <span class="required" style="color: red;"><?php echo "$msg";?></span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input id="date" class="date-picker one form-control col-md-7 col-xs-12" type="text" name="date">
                        </div>
                           
									 <label class="control-label col-md-1 col-sm-1 col-xs-12">Time :</label>										
									 <input type="text" id="clockbox" class="control-label col-md-1 col-sm-3 col-xs-6" name="go" style="border:none" readonly>								
					   				 </div>
									...
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Delar <span class="required" style="color: red;">*</span></label>
										...
										<?php while ($row1 = $result1->fetch_assoc()){$name= $row1['Name'];echo '<option>'.$name.'</option>';}?>
										</select>
										</div>
									</div>
									<div class="form-group">
					     ...
					     <label  class="control-label col-md-3 col-sm-3 col-xs-6"> Received Quantity <span class="required" style="color: red;">*</span></label>	
						 
						 <div class="col-md-2">
						 <input type="text" name="received" id="rec" required="required" placeholder="00" class="form-control col-md-7 col-xs-12" onKeyup="sum();"/> 
						 </div>
						 ...
						 <div class="col-md-2">					
                         <input type="text" name="rate" id="rate" required="required" placeholder="00.00" class="form-control col-md-7 col-xs-12" onKeyup="sum();"/>
                         </div> 
									...
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Total Amount<span class="required" style="color: red;">*</span> <i class="fa fa-inr"></i>
										...
										<div class="col-md-3 col-sm-6 col-xs-10">
										<input type="text" name="pri" id="price"  placeholder="00" required="required" class="form-control col-md-7 col-xs-12">
										</div>
									</div>
 									<div class="form-group">
